...
form = Form({'nombre': 'Test Admin 2', 'codigo_activo': 'ADMIN-002', 'cantidad_total': 1, 'cantidad_buena': 1, 'cantidad_regular': 0, 'cantidad_mala': 0, 'estatus_general': 'bueno'})

if form.is_valid():
    print("Form is valid! It can be saved without laboratorio.")
    obj = form.save(commit=False)
    obj.save()
    print("Saved ID:", obj.id, "Lab:", obj.laboratorio)
else:
