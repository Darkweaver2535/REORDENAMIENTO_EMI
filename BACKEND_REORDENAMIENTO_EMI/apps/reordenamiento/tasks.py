...
from apps.reportes.pdf_utils import construir_pdf_reordenamiento
...
def generar_pdf_reordenamiento(self, reordenamiento_id):
    ...
    autorizador_nombre = (
        reordenamiento.autorizado_por.nombre_completo if reordenamiento.autorizado_por else None
    )

    try:
        pdf_bytes = construir_pdf_reordenamiento(
            reordenamiento,
